...
import ar.edu.davinci.auth.TheOtherUser;
...
public class ProfileMb {
	...
	@Inject
	private TheOtherUser theOtherUser;
	...
	public String follow() {
		theOtherUser.setUser(userCntr.follow(authMb.getUser(), otherUser));
		return "following?faces-redirect=true";
	}
